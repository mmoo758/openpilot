...
========================
* 此版本为dzid26的3fm-vtb-lkas修改C3L版本
* 修改开机图片及新手指南中文
...
Version 0.10.1 (2025-10-17)
========================
* 此版本为dzid26的3fm-vtb-lkas修改C3L版本
* 删除更新#1396、#1395、#1381、#1393、#1390
* 以上更新导致停车计时器、红绿灯和前车驶离屏幕提醒异常
...
Version 0.10.1 (2025-10-15)
========================
* 此版本为dzid26的3fm-vtb-lkas修改C3版本
* 同步master的更新
* 停车计时器透明度降低
* 限速辅助：在特定状态下发出声音警报
* 限速标记显示策略更新
